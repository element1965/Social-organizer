...
- Сбор **без указания целевой суммы** — создатель не задаёт цель. Это единственное исключение из правила «укажи сумму при создании». Обычные пользователи обязаны указывать сумму, Автор и Разработчик — нет. Участники вносят обязательства как обычно (минимум 10 единиц).
- **Уведомление приходит не сразу**, а **только после того, как пользователь впервые кому-то помог** (взял обязательство по любому сбору). Это гарантирует, что человек уже понимает, как работает система, и готов осознанно решить.
